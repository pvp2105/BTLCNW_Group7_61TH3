                ...
                <div class="container-fluid ms-5">
                    ...
                    <div class="collapse navbar-collapse ms-5" id="navbarSupportedContent">
                        <ul class="navbar-nav ms-5 mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="mynetwork.php">
                ...
                <div class="sidebar col-md-3 ps-2">
                    <div class="my-sidebar list-group-item bg-white">     
                        ...
                        <div class="sidebar_categories ">
                            ...
                            <hr>
                            <h5 style="color: blue;">Grow your network</h5>
                            <hr>
                    ...
                    <div class="post list-group bg-white row ">
                        <div class="col-md-12 m-2">
                            <div class="row Text">
                                ...
                                <p class="Start">Manager</p>
                            </div>
                        </div>
                    </div>
                    <div class="list-group bg-white row mt-2 mb-4">
                        <div class="row company-job m-4">
                            <div class="row directory mb-3">
                                <div class="avt-actor col-md-2">
                                    <a href=""><img class="img-actor" src="assets/images/img1_mynetwork.jpg" alt=""style="width:60px;"></a>
                                </div>
                            ...
                            <div class="input-group flex-nowrap mb-3">
                                <input type="text" class="form-control" placeholder="longdp2001@gmail.com" aria-label="Username" aria-describedby="addon-wrapping">
                            </div>
                            <div class="nav-item ms-2 me-2 mb-2">
                                <a href="">
                                    <button class="btn-signin text-primary mt-1">Continue</button>
                                </a>
                            </div>
                            <div class="More">
