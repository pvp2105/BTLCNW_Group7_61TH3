    ...
    <main class="container-fluid" style="background: #f3f2ef; margin-top: 68px;">
        ...
        <div class="main-about row ms-5 me-5 ps-5">
                        ...
                        <a href="#" class="list-identity">
                            <div class="row text-align-left">
                                ...
                                <div class="col-md-10 sidebar-more p-2">
                                    ...
                                    <button class=" bt-event-plus"><i class="bi bi-plus-lg float-end" style="font-size: 15px;"></i></button>
                                </div>
                                <div class="col-md-10 sidebar-more p-2">
            ...
            <div class="main col-md-5 ms-3">
                <div class="post list-group bg-white row ">
                    <div class="col-md-12 m-2">
                        <span class="start-post" style="text: center;">
                            <a href=""><img class="col-md-1 mt-3 avt-friend"  src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQNL_ZnOTpXSvhf1UaK7beHey2BX42U6solRA&amp;usqp=CAU"></a>
                        </span>
                        <span class="ms-2">
                            <button type="button" class="btn-start btn-block btn-lg col-md-10">
                                <p class="mt-3" style="text-align: left; font-size: 14px; color:rgb(124, 107, 107) ">Start a posts</p> 
                            </button>
                        </span>
                    </div>
                    <div class="col-md-12 m-2">
                    ...
                    <div class="col-md-12 m-2 ">
                        ...
                        <div class="list-friends mt-2" >
                            <a class="col-md-2" href="" style="text-decoration: none; color: #000;">
                                <img class="avt-friend" src="https://media-exp1.licdn.com/dms/image/C560BAQFkDzx_7dqq3A/company-logo_100_100/0/1519902995023?e=1648684800&v=beta&t=oVdH-VqT_ge8AGBvJBVaiZjH8_d3ehNrrsEHT60HTVk" alt="">
                                <span>Spotify
                        ...
                        <div class="list-friends mt-2">
                            <a class="col-md-2" href="" style="text-decoration: none; color: #000;">
                                <img class="avt-friend" src="https://media-exp1.licdn.com/dms/image/C560BAQFckBxRnPg53Q/company-logo_200_200/0/1561999707114?e=1648684800&v=beta&t=MJSvvgGEZdc9UyxIe0OPcx16Wpblipu7Fc8u96nz6rU" alt="">
                                <span>Nike
                ...
                <div class="feed-share list-group bg-white row mt-2">
                    <div class="col-md-12 m-2 ">
                        <div class="row share-actor">
                            <div class="avt-actor  col-md-2">
                                <a href=""><img class="img-actor" src="https://media-exp1.licdn.com/dms/image/C560BAQHTvZwCx4p2Qg/company-logo_100_100/0/1612205615891?e=1648684800&v=beta&t=Bg7klz_e_AdmdMcrIHDuo84ROCuuF5FWRaJ14MSJMmA" alt=""></a>
                            </div>
                            <div class="col-md-10">
                                <span >
                            ...
                            <div class="row cap-post">
                                <p>Seema Degwekar is a Senior Principal Engineer, and has been at Amazon for 13 years. Learn more about her time at Amazon and the Principal Engineering Community here: 
                                    <a href="https://amzn.to/2ZE6hKC">https://amzn.to/2ZE6hKC</a>
                                </p> 
                            </div>
                            <div class="row content-post">
                                <img src="https://media-exp1.licdn.com/dms/image/C5622AQG6jeV2MeteGg/feedshare-shrink_800/0/1640012403280?e=1643241600&v=beta&t=hKgvRtIfpWyI7fwM48UvwnRTvS6tTPa3xkaEaXVWuyw" alt="">
                            </div>
                            <div class="row status mt-1 mb-1">
                                <span>
                                    <i class="bi bi-hand-thumbs-up-fill" style="color: blue;"></i>
                ...
                <div class="feed-share list-group bg-white row mt-2 mb-5">
                    <div class="col-md-12 m-2 ">
                        <div class="row share-actor">
                            ...
                            <div class="col-md-10">
                                <span class="">
                                    <a class="name-actor" href="" style="text-decoration: none; color: #000;">Bill Gates</a>
                                    <i class="bi bi-linkedin" style="color: blue"></i></a>
                                    <a href="" style="text-decoration: none; color: rgb(119, 108, 108);">Following</a>
                                </span>
                                <div class="descrip ">
                            ...
                            <div class="row cap-post">
                                <p>One of my favorite holiday traditions is sharing books with family and friends. Here are 5 books I loved reading this year.</p>
                            </div>
                            <div class="row content-post">
                                <a href="#" class="list-identity">
            ...
            <div class="news col-md-3 ">
                <div class="my-sidebar list-group bg-white">
                    <div class="row mt-2 ms-2 me-2"><p>LinkedIn News <i class="bi bi-info-square-fill" style="float: right;"></i></p></div>
                    <div class="row-news">
                        <ul>
                    ...
                    <div class="list-group-item">
                        <div class="row promote">
                            ...
                            <div class="col-md-9 ms-4" style="display: inline;">
                                ...
                                <div class="descrip ">
                                    <p style="color: rgb(119, 108, 108); font-size: 12px;"> Developed with UNSW Canberra at the Australian Defence Force Academy (ADFA) </p>
                                </div>
                            </div>
                        </div>
                        <div class="row promote">
